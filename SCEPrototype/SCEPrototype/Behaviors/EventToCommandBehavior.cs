...
using SCEPrototype.Behaviors.Base;
using System;
...
namespace SCEPrototype.Behaviors
{
    public class EventToCommandBehavior : BindableBehavior<View>
    {
        Delegate eventtHandler;
        ...
        void RegisterEvent(string name)
        {
            ...
            eventtHandler = methodInfo.CreateDelegate(eventInfo.EventHandlerType, this);
            eventInfo.AddEventHandler(AssociatedObject, eventtHandler);
        }
